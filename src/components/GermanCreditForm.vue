<template>
  <div class="card bg-base-100 shadow-xl w-full">
    <div class="card-body">
      <h1 class="card-title text-2xl font-bold mb-2">Sistema Alemán</h1>
      <p class="text-base-content/60 text-sm mb-4">
        Abonás un capital fijo cada período; los intereses disminuyen mes a mes
      </p>
...
const emit = defineEmits<{
  calculate: [payload: { amount: string; installments: string; rate: string; rateType: 'monthly' | 'annual' }]
  reset: []
}>()
