...
function buildAmericanSchedule(amount: number, months: number, r = 0.015): AmortizationRow[] {
...
describe('AmericanAmortizationTable', () => {
  ...
  describe('american schedule structure', () => {
    ...
    it('last row has a higher total payment than the periodic rows', () => {
      ...
      expect(schedule[3].totalPayment).toBeGreaterThan(schedule[0].totalPayment)
    })
